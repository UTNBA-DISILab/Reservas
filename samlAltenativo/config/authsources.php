...
$config = array(
    ...
    'default-sp' => array(
        ...
        // Can be NUL/unset, in which case an entity ID is generated based on the metadata URL.
        'entityID' =>'localhost/simplesaml/',

        // The entity ID of the IdP this should SP should contact.
        // Can be NULL/unset, in which case the user will be shown a list of available IdPs.
       'privatekey' => 'saml.pem',
       'certificate' => 'saml.crt',
       // 'idp' =>'http://idp-dev.frba.utn.edu.ar/saml2/idp/metadata.php',
